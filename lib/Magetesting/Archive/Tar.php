 ...
 */
class Magetesting_Archive_Tar extends Magetesting_Archive_Abstract implements Magetesting_Archive_Interface
{
    /**
     * Tar block size
     *
    ...
    * Tarball data writer
    *
    * @var Magetesting_Archive_Helper_File
    */
    protected $_writer;
    ...
    */
     ...
     *
     * @return Magetesting_Archive_Tar
     */
    protected function _initWriter()
    {
        $this->_writer = new Magetesting_Archive_Helper_File($this->_destinationFilePath);
        $this->_writer->open('w');
    ...
    {
        if ($this->_writer instanceof Magetesting_Archive_Helper_File) {
            $this->_writer->close();
            $this->_writer = null;
        }
     ...
     * Get tarball writer
     *
     * @return Magetesting_Archive_Helper_File
     */
    ...
    {
        $this->_reader = new Magetesting_Archive_Helper_File($this->_getCurrentFile());
        $this->_reader->open('r');
    ...
    {
        if ($this->_reader instanceof Magetesting_Archive_Helper_File) {
            $this->_reader->close();
            $this->_reader = null;
        }
    ...
    */
    ...
    protected function _packAndWriteCurrentFile()
    {
        ...
        if (is_file($currentFile) && !is_link($currentFile)) {
            $fileReader = new Magetesting_Archive_Helper_File($currentFile);
            $fileReader->open('r');
    ...
    {
        $fileWriter = new Magetesting_Archive_Helper_File($destination);
