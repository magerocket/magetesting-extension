...
class Magetesting_Backup
{
     ...
     * @var array
     */
    static protected $_allowedBackupTypes = array('db', 'snapshot', 'filesystem', 'media', 'nomedia', 'nomedianodb', 'dbclean');
    ...
    {
        $class = 'Magetesting_Backup_' . ucfirst($type);
