...
/**
 * Filesystem helper for Magetesting_Backup library
 *
 * @category    Mage
 * @package     Magetesting_Backup
 * @author      Magento Core Team <core@magentocommerce.com>
 */
class Magetesting_Backup_Filesystem_Helper
{
    /**
    ...
    public function rm($path, $skipPaths = array(), $removeRoot = false)
    {
        ...
        $iterator = new Magetesting_Backup_Filesystem_Iterator_Filter($filesystemIterator, $skipPaths);
    ...
    public function getInfo($path, $infoOptions = self::INFO_ALL, $skipFiles = array())
    {
        ...
        $iterator = new Magetesting_Backup_Filesystem_Iterator_Filter($filesystemIterator, $skipFiles);
