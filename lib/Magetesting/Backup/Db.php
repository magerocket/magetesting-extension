 ...
 */
class Magetesting_Backup_Db extends Magetesting_Backup_Abstract
{
    /**
    ...
    public function rollback()
    {
        ...
        $archiveManager = new Magetesting_Archive();
        $source = $archiveManager->unpack($this->getBackupPath(), $this->getBackupsDir());

        $file = new Magetesting_Backup_Filesystem_Iterator_File($source);
